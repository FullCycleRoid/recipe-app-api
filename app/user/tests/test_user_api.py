...
class PublicUserApiTest(TestCase):
    ...
    def test_create_token_for_user(self):
        ...
        payload = {"email": '123@13345.com', 'password': 'testpass'}
        create_user(**payload)
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='123@1334.com', password='testpass')
        payload = {"email": '123@1334.com', 'password': 'wrong'}
        res = self.client.post(TOKEN_URL, payload)
...
class PrivateUserApiTests(TestCase):
    ...
    def test_update_user_profile(self):
        ...
        payload = {'name': 'new_name', 'mail': 'test123@mail.com', 'password': 'newpassword123'}
